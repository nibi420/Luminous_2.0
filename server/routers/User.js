...
import { getDonCats, getDonationLatest, getDonationsData, pledge, pushDonCats, pushDonationsData } from "../controllers/Donations.js";
...
router.route("/pledge").post(pledge);
